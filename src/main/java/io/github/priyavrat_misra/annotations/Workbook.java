...
/**
 * Annotation to mark a class for processing with {@link Poijo} as well as specifying properties.
 * For now, it only has support for <i>delimiter</i> property which is used when generating titles
 * for columns and sheets in the workbook.
 *
 * <p>Example usage:
 *
 * <pre><code>
